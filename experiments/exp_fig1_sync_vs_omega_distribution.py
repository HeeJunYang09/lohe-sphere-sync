# Data generation for PRL Figure 1
import os, sys
import numpy as np
...
save_dir = os.path.join(project_root, "experiments", "results", "figure1")
...
x0 = random_points_on_s2(N, alpha=alpha, seed=seed) # Initial positions on S^2
